...
export const URL_REGISTER = import.meta.env.VITE_URL_REGISTER;
export const URL_LOGIN = import.meta.env.VITE_URL_LOGIN;
export const CACHE_EXPIRATION_TIME = 120000;
