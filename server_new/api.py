...
import json
from phonatics import phonatic_search
from semantic import semantic_search
from string_search import string_search
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://127.0.0.1:5173", "http://localhost:3000"],  # Specific origins for better security
